...
import LeftGIF1 from "../../assets/product imgs/Lgif1.gif";
import LeftGIF2 from "../../assets/product imgs/Lgif2.gif";
import LeftGIF3 from "../../assets/product imgs/Lgif3.gif";
import LeftGIF4 from "../../assets/product imgs/Lgif4.gif";

import RightGIF1 from "../../assets/product imgs/Rgif1.gif";
import RightGIF2 from "../../assets/product imgs/Rgif2.gif";
import RightGIF3 from "../../assets/product imgs/Rgif3.gif";
import RightGIF4 from "../../assets/product imgs/Rgif4.gif";
import RightGIF5 from "../../assets/product imgs/Rgif5.gif";
import ProductBanner2 from "../../assets/product imgs/ProductBanner3.png";

import Thumbnail from "../../assets/product imgs/thumbnail.png";
import { FaPlay } from "react-icons/fa";

const items = [
  { img: LeftGIF1, label: "Accounting" },
  { img: LeftGIF2, label: "Healthcare" },
  { img: LeftGIF3, label: "Realestate" },
  { img: LeftGIF4, label: "Retai" },
...
const ProductSection3: React.FC = () => {
      ...
      >
        ...
        <div className="relative space-y-6 sm:space-y-8 px-4 sm:px-6 w-full max-w-full sm:max-w-[540px] md:max-w-[740px] mt-40 sm:mt-48 md:mt-60">
          <h2 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[54px] leading-[1.2] sm:leading-[1.3] md:leading-[56px] lg:leading-[60px]">
            PaperLens Scan Anything Store Everything
          </h2>
          <p className="text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-light leading-[1.4] sm:leading-[20px] md:leading-[22px] lg:leading-[25px] text-[#FFFFFF]">
            PaperLens instantly converts any document you capture—business
            cards, invoices, IDs, or receipts—into a smart, searchable digital
            file, automatically detects the document type, organizes it into the
            right folder, and lets you save or share it effortlessly.
          </p>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16 md:gap-18 items-start pb-10 md:pb-28">
          ...
          <div className="space-y-12 sm:space-y-14 md:space-y-16">
            ...
            <p className="text-base sm:text-lg leading-[1.4] sm:leading-[26px] md:leading-[28px] lg:leading-[30px]">
              Paper Lens is an advanced AI powered document scanning tool that
              allows users to effortlessly capture and convert business cards,
              invoices, receipts, IDs, and other important documents into
              organized digital files. It automatically detects the type of
              document and categorizes it into the appropriate folder for easy
              access. Ideal for individuals, professionals, and businesses who
              need a fast, efficient, and reliable way to digitize, store, and
              share important documents with complete ease.
            </p>
            ...
            <div className="flex flex-col sm:flex-row h-auto sm:h-[345px] gap-3 ">
              <div className="bg-[#1F1F1F] w-full sm:w-[435px] p-6 sm:p-8 flex flex-col justify-between items-start rounded-md">
                ...
                <p className="text-sm sm:text-base leading-[1.4] sm:leading-[22px] font-light w-full max-w-full sm:max-w-[300px] text-[#DBDBDB] mt-4 sm:mt-0">
                  Automatically identifies and categorizes documents such as business cards, invoices, and receipts.
                </p>
                <div className="w-full flex justify-center md:justify-end mt-4 sm:mt-0">
                  <img
                    src={RightGIF1}
                    alt=""
                    className="w-20 h-20 sm:w-[94.64px] sm:h-[94.64px]"
                  />
                </div>
              </div>
              ...
              <div className="bg-[#1F1F1F] flex-1 p-6 sm:p-8 flex flex-col sm:flex-row items-start justify-between rounded-md gap-4 sm:gap-0">
                <div className="space-y-4 sm:space-y-5">
                  ...
                  <p className="text-sm sm:text-base leading-[1.4] sm:leading-[22px] font-light w-full max-w-full sm:max-w-[270px] text-[#DBDBDB]">
                    Sorts documents into the appropriate folders for easy access and retrieval.
                  </p>
                </div>
                <div className="w-full sm:w-auto flex justify-center sm:justify-end items-end mt-4 sm:mt-0 sm:self-end">
                  <img
                    src={RightGIF2}
                    alt=""
                    className="h-[120px] w-[120px] sm:h-[180px] sm:w-[180px] md:h-[200px] md:w-[200px] lg:h-[190.73px] lg:w-[190.73px]"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="bg-[#1F1F1F] rounded-md p-6 sm:p-8 flex flex-col justify-between space-y-4 sm:space-y-5 items-center">
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-sm sm:text-base leading-[1.4] sm:leading-[22px] font-light w-full max-w-full sm:max-w-[270px] text-[#DBDBDB] text-left">
                    Allows users to share scanned documents via email or messaging apps without hassle.
                  </p>
                </div>
                <img
                  src={RightGIF3}
                  alt=""
                  className="h-[120px] sm:h-[150px] md:h-[180px] lg:h-[172px] lg:w-[172px] object-contain"
                />
              </div>
              ...
              <div className="col-span-1 sm:col-span-2 flex flex-col gap-3 ">
                <div className="bg-[#1F1F1F] w-full p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between rounded-md gap-4 sm:gap-0">
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    <p className="text-sm sm:text-base leading-[1.4] sm:leading-[22px] font-light w-full max-w-full sm:max-w-[270px] text-[#DBDBDB]">
                      Syncs documents with cloud storage for secure and easy access from any device.
                    </p>
                  </div>
                  <img
                    src={RightGIF4}
                    alt=""
                    className="h-[120px] sm:h-[150px] md:h-[180px] lg:h-[163px] lg:w-[163px] object-contain"
                  />
                </div>
                ...
                <div className="bg-[#1F1F1F] w-full p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between rounded-md gap-4 sm:gap-0">
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    <p className="text-sm sm:text-base leading-[1.4] sm:leading-[22px] font-light w-full max-w-full sm:max-w-[270px] text-[#DBDBDB]">
                      Uses OCR technology to make scanned documents searchable, making it easy to locate specific files.
                    </p>
                  </div>
                  <img
                    src={RightGIF5}
                    alt=""
                    className="w-[100px] h-[100px] sm:w-[120px] sm:h-[120px] md:w-[155px] md:h-[155px]"
                  />
                </div>
              </div>
            </div>
